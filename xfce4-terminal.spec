...
Source0  : http://archive.xfce.org/src/apps/xfce4-terminal/0.8/xfce4-terminal-0.8.5.1.tar.bz2
...
%prep
%setup -q -n xfce4-terminal-0.8.5.1
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1494947106
