...
Source0  : https://archive.xfce.org/src/apps/xfce4-terminal/1.0/xfce4-terminal-1.0.3.tar.bz2
...
%prep
%setup -q -n xfce4-terminal-1.0.3
cd %{_builddir}/xfce4-terminal-1.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652480668
...
cp %{_builddir}/xfce4-terminal-1.0.3/COPYING %{buildroot}/usr/share/package-licenses/xfce4-terminal/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
