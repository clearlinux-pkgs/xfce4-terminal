...
Source0  : http://archive.xfce.org/src/apps/xfce4-terminal/0.8/xfce4-terminal-0.8.6.tar.bz2
...
%prep
%setup -q -n xfce4-terminal-0.8.6
...
export LANG=C
export SOURCE_DATE_EPOCH=1505699969
