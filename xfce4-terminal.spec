...
Source0  : https://archive.xfce.org/src/apps/xfce4-terminal/1.0/xfce4-terminal-1.0.1.tar.bz2
...
%prep
%setup -q -n xfce4-terminal-1.0.1
cd %{_builddir}/xfce4-terminal-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649894598
...
cp %{_builddir}/xfce4-terminal-1.0.1/COPYING %{buildroot}/usr/share/package-licenses/xfce4-terminal/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
